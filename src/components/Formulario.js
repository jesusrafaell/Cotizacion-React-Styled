...
import { getDiferentYear, calculatorMarca, getPlan} from '../Helpes';
...
const Formulario = ({saveResumen, saveLoad}) => {
    ...
    const cotizarSeguro = e => {
        ...
        //Europeo 30%
        //Asiatico 5
        resultado = calculatorMarca(marca) * resultado;
